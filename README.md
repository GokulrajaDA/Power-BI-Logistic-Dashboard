...
Data Modeling
Loaded cleaned Excel into Power BI DesktopChanged Delivery_Date data type to Date in Power QueryRemoved errors and replaced nullsCreated relationship: Log 1[Vehicle_ID] → Log[Vehicle_ID] as 1 to Many, Single directionCreated a calculated column for Route: Route = 'Log'[Origin] & " to " & 'Log'[Destination]DAX Measures Createddax-- Count & Delivery Performance
...
Theme: Dark theme with cards for KPI highlighting

## 🔍 4. Key InsightsFrom the analysis of 50 trips:52% of deliveries were Late and 48% were On-TimeLongest Trip: T045 - Kolkata to Chennai: 1803 KM with highest fuel consumptionWorst Fuel Efficiency: T023 - 1729 KM with 197.55 fuel unitsHighest Maintenance Cost: Truck vehicle type contributed to 40% of total maintenanceMost Active Route: Hyderabad ↔ Delhi with 6 tripsAvg Distance per Trip: 842 KMOverall Fuel Efficiency: 8.7 KM per unit

 maintenanceMost Active Route: Hyderabad ↔ Delhi with 6 tripsAvg Distance per Trip: 842 KMOverall Fuel Efficiency: 8.7 KM per unit
